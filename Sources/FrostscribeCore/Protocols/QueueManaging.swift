...
public extension QueueManaging {
    func add(input: URL, output: URL, preset: String, title: String, episode: String? = nil, quality: Int) throws {
        try add(input: input, output: output, preset: preset, title: title, episode: episode, audioTracks: nil, quality: quality)
    }
